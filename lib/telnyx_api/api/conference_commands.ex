...
defmodule TelnyxAPI.Api.ConferenceCommands do
  ...
  - connection (TelnyxAPI.Connection): Connection to server
  - id (String.t): Uniquely identifies the conference by id or name
  - leave_conference_request (LeaveConferenceRequest): Leave Conference request object
  - opts (KeywordList): [optional] Optional parameters
  ## Returns
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec conference_leave(Tesla.Env.client, String.t, TelnyxAPI.Model.LeaveConferenceRequest.t, keyword()) :: {:ok, nil} | {:ok, TelnyxAPI.Model.ConferenceCommandResponse.t} | {:error, Tesla.Env.t}
  def conference_leave(connection, id, leave_conference_request, _opts \\ []) do
    %{}
    |> method(:post)
    |> url("/conferences/#{id}/actions/leave")
    |> add_param(:body, :body, leave_conference_request)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %TelnyxAPI.Model.ConferenceCommandResponse{}},
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :filter_left_square_bracketstatus_right_square_bracket (String.t): If present, conferences will be filtered by status.
    - :page_left_square_bracketnumber_right_square_bracket (integer()): The page number to load
    - :page_left_square_bracketsize_right_square_bracket (integer()): The size of the page
  ## Returns
