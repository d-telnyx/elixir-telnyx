...
defmodule TelnyxAPI.Model.ConferenceParticipantSpeakEndedPayload do
  @moduledoc """
...
defimpl Poison.Decoder, for: TelnyxAPI.Model.ConferenceParticipantSpeakEndedPayload do
